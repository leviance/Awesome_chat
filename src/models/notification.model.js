...
const NOTIFICATION_CONTENTS = {
  getContent : (notificationType,isRead,userId,username,userAvatar) =>{
    ...
    if(notificationType === NOTIFICATION_TYPES.APPROVE_CONTACT){
      if(!isRead){
        return '<div class="notif-readed-false" data-uid="'+ userId +'"><img class="avatar-small" src="images/users/'+ userAvatar +'" alt=""> <strong>'+ username +'</strong> đã chấp nhận lời mời kết bạn của bạn!</div>';
      }
      return '<div data-uid="'+ userId +'"><img class="avatar-small" src="images/users/'+ userAvatar +'" alt=""> <strong>'+ username +'</strong> đã chấp nhận lời mời kết bạn của bạn!</div>';
    }
